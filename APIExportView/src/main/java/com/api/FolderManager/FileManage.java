...
public class FileManage  implements FilenameFilter  {
    ...
    public  FileManage(String filterName)
    {
...
//       
   ...
   public  void moveFile(String DownloadsFilePath,String DestFilePath,String filterName)
   {
   ...
   public static String[] fileSearching(File Folderdirectory,String filterName)
   {
   ...
   public  boolean fileCopying(String source,String destination)
   {
       try
       {
   ...
   public  boolean fileCompress(String[] srcFiles,String SourceFilePath,String DestFilePath)
   {
   ...
   public  void fileArchive(String DownloadsFilePath,String DestFilePath,String filterName)
   {
   }
}
